...
import { ActivityIndicator, StyleSheet, View, TextInput, Dimensions } from 'react-native'
    ...
    return (
        <View style={[s.screen, { backgroundColor: colors('semiBack', darkTheme), }]}>
            <View style={s.searchBox}>
                ...
                <Icon style={{ marginHorizontal: 5 }} name="magnifying-glass" size={24} color="black" />
            </View>
            {!foundUser &&
